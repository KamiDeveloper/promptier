// POST /api/ai/suggest — suggest title, description, tags, type, model
import { type NextRequest, NextResponse } from 'next/server'
import { requireAuth } from '@/lib/auth/requireAuth'
import { suggestMetadata } from '@/lib/services/aiService'
...
export async function POST(req: NextRequest) {
  ...
  try {
    const result = await suggestMetadata({ userId }, content)
